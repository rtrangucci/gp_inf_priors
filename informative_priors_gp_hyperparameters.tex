...
\begin{abstract}
  ...
  nonparameteric regression models. However, the joint posterior density of the
  length scale and marginal variance hyperparameters is often weakly informed
  by the data because of the extreme flexibility of Gaussian process priors, 
  which can lead to Markov Chains that aren't geometrically ergodic. We
  develop a principled approach for specifying informative priors for length
